...
| `1.6.0`      | `0.3.8-preview.1` | `0.5.0-preview.1` | Durable bounded dataset quality-policy gate  |
| `1.7.0`      | `0.3.9-preview.1` | `0.6.0-preview.1` | Durable bounded reference-integrity gate     |
